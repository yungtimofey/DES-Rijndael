...
public final class RoundKeysGeneratorImpl implements RoundKeysGenerator {
    ...
    public byte[][] generate(byte[] key64Bits) {
        ...
        BitSet leftHalfOfBitset = GetHalfOfPC_1(bitSet, 0, PC_1_LENGTH/2);
        //print(leftHalfOfBitset);

        BitSet rightHalfOfBitset = GetHalfOfPC_1(bitSet, PC_1_LENGTH/2, PC_1_LENGTH);
    ...
    private BitSet GetHalfOfPC_1(BitSet bitSet, int start, int end) {
